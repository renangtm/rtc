                                                ...
                                                <div class="user-avatar-info">
                                                    ...
                                                    <div class="user-avatar-address">
                                                        ...
                                                        <div class="mt-3 col-8">
                                                            ...
                                                            <p style="text-align: justify;">Nos contratos de Representação Comercial a Virtual Negócios e Serviços estará abrindo através de um relacionamento virtual contatos onde todos os fornecedores se comprometam a interagir com nosso Paradigma no tocante à Preços Baixos.</p> 
                                                            ...
                                                            <p style="text-align: justify;">Ainda no módulo 1 a Virtual conta com toda sua equipe para dar suporte aos primeiros passos em nosso RTC (ERP), oferecendo orientações sobre como comprar em nosso Serviço de Compras Parceiro, como encomendar um produto diretamente com os Compradores do Projeto Novos Rumos e ainda como cadastrar seus Produtos, Clientes, Fornecedores e Transportadoras.</p> 
                                                            
                                                            <br><br>
                                                            <img src="assets/images/rtc_institucional_virtual_modulo_dois.png" alt="User Avatar">
                                                            <br><br>
                                                            <h3>Módulo Dois(2) do RTC</h3>
                                                            <p style="text-align: justify;">No módulo Dois (2) o Logistic Center Gru (LCG) se apresenta como mais um aliado dos seus negócios nos Transportes e Armazenagem. Esse serviço chega até nossos clientes pela Virtual através de sua equipe de assistentes habilitadas para fazer seu cadastramento junto às suas transportadoras e demais existentes em sua cidade. Dessa forma os clientes do Módulo dois poderão montar seus pedidos com identificação de sua empresa, e também serão destacados nos pedidos o preço inicial, frete, icms, custo financeiro e preço final.</p>
                                                            <p style="text-align: justify;">O melhor ainda é que o Módulo 2 é inteiramente grátis para as primeiras empresas cadastradas, e nossos clientes terão seus pedidos iguaizinhos aos da Agro Fauna! Para isso, é necessário um contrato com o Logistc Center onde você o autoriza a buscar em seu nome as tabelas de preço de frete com as transportadoras de sua cidade. Para fretes partindo de qualquer outra cidade do Brasil poderão ser usadas tabelas do Logistic Center.</p> 
