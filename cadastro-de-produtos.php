                            ...
                            <div class="card-body">
                                <div class="table-responsive">
									<div class="product-btn m-b-20">
										<a href="#" class="btn btn-primary" data-title="Add" data-toggle="modal" data-target="#add" ><i class="fas fa-plus-circle m-r-10"></i>Adicionar Produtos</a>
									</div>
                                    <table id="clientes" class="table table-striped table-bordered first">
                                        <thead>
											...
											<tbody>
												<tr>
													...
													<th>
														<div class="product-btn">
															<a href="#" class="btn btn-outline-light btninfo" data-toggle="collapse" data-target="#demo1" class="accordion-toggle"><i class="fas fa-info-circle"></i></a>
															<a href="#" class="btn btn-outline-light btnedit" data-title="Edit" data-toggle="modal" data-target="#edit"><i class="fas fa-pencil-alt"></i></a>
															...
															<div class="row mx-auto m-b-30">
																<div class="col">
																	<table class="table table-bordered w-100">
																	  ...
																	  <tr>
																		<td colspan="2">Restrições por estado: BA / ES / SP</td>
																	  </tr>
																	  <tr>
																		<td colspan="2">Parametros para faturamento: &nbsp;
																		<select name="trib" class="form-control-sm" disabled>
																		  <option value="">sem tributação</option>
																		  <option value="" selected>Tributação normal</option>
																		  <option value="">Tributação especial 4%</option>
																		</select></td>
																	  </tr>
																	  <tr>
																		<td colspan="2">Indicação de Uso</td>
																	  </tr>
																		<tr>
																			<td></td>
																			<td></td>
																	  ...
																	  <tr>
																		<td colspan="2"><p>imagem do produto:</p>
																			<div class="row text-center m-t-20">
																				<div class="col">
																					<label class=newbtn>
																						<img id="" width="50%"  src="http://www.faunasystem.com.br:8080/rtc/danimen1l.png" >
																					</label>
																				</div>
																			</div>
												...
												<tr>
													<td>37227</td>
													<td>Kumulus DF (Pct 1Kg)</td>
													<td></td>
													<td>0</td>
													<td>-40</td>
													<td>0</td>
													<td>17.36</td>
													<td>ENXOFRE ELEMENTAR (SULPHUR)</td>
													<th>
														<div class="product-btn">
															<a href="#" class="btn btn-outline-light btninfo" data-toggle="collapse" data-target="#demo2" class="accordion-toggle"><i class="fas fa-info-circle"></i></a>
															<a href="#" class="btn btn-outline-light btnedit" data-title="Edit" data-toggle="modal" data-target="#edit"><i class="fas fa-pencil-alt"></i></a>
															<a href="#" class="btn btn-outline-light btndel" data-title="Delete" data-toggle="modal" data-target="#delete"><i class="fas fa-trash-alt"></i></a>
														</div>
													</th>
																	  ...
																	  <tr>
																		<td colspan="2"><p>imagem do produto:</p>
																			<div class="row text-center m-t-20">
																				<div class="col">
																					<label class=newbtn>
																						<img id="" width="50%"  src="http://www.faunasystem.com.br:8080/rtc/kumulus-df-pct-1kg.png" >
																					</label>
																				</div>
																			</div>
																			<div class="row text-center justify-content-center m-t-10">
		  ...
		  <div class="modal-content">
			 ...
			 <nav>
				  <div class="nav nav-tabs" id="nav-tab" role="tablist">
					...
					<a class="nav-item nav-link text-center" id="nav-rest-tab" data-toggle="tab" href="#nav-rest" role="tab" aria-controls="nav-rest" aria-selected="false">Restrições<br>por estado</a>
					<a class="nav-item nav-link text-center" id="nav-fat-tab" data-toggle="tab" href="#nav-fat" role="tab" aria-controls="nav-fat" aria-selected="false">Fatura-<br>mento</a>
				  </div>
			</nav>
