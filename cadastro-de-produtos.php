                            ...
                            <div class="modal-body">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link text-center" id="nav-uso-tab" data-toggle="tab" href="#nav-uso" role="tab" aria-controls="nav-uso" aria-selected="false">Indica?�?�es<br> de uso</a>
                                    </div>
                                </nav>
                ...
                <div class="modal-dialog" style="position:absolute;top:calc(100% - 380px)">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <br>
                            <h3 style="margin-top:20px;">Carregando as informa?�?�es...</h3>
