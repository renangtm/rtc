                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-t-30">
                                    ...
                                    <div class="page-item" ng-click="usuarios.next()" style="width:105px;display: inline-block;margin-left: 5px;margin-bottom:5px"><a class="page-link" href="">PrÃ³ximo</a></div>
