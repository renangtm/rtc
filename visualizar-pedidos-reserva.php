<html lang="en" ng-app="appRtc">
    ...
    <body ng-controller="crtPedidosReserva">
        <!-- ============================================================== -->
        <!-- main wrapper -->
        <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h2 class="pageheader-title">Pedidos de Reserva</h2>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">      
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Pedidos de Reserva</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <div class="product-btn m-b-20">
                                                <a href="#" class="btn btn-primary" data-title="AddCompra" ng-click="novoPedido()" data-toggle="modal" data-target="#editCompra" ><i class="fas fa-plus-circle m-r-10"></i>Cadastrar Pedido de Reserva</a>
                                            </div>
                                            <hr><br>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php if ($usuario->temPermissao(Sistema::P_EMPRESA_PEDIDO()->m('C'))) { ?>
                                                            <th>Empresa</th>
                                                        <?php } ?>
                                                        <th width="105px" data-ordem="pedido.usuario.nome">Criador</th>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title m-t-10" id="exampleModalLongTitle"><i class="fas fa-pencil-alt fa-3x"></i>&nbsp;&nbsp;&nbsp;Configure os dados de seu Pedido de Reserva ({{pedido.id}})</h5>
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <table id="" class="table table-striped" width="90%">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="9" style="text-align:right;">VALOR TOTAL R$ {{getTotalPedido().toFixed(2)}}</th>
                                                <th></th>
                                            </tr>
                                        </tfoot>		
                                    </table>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <input ng-disabled="!pedido.status.altera" type="number" class="form-control col-5" ng-model="pedido.prazo" ng-confirm="atualizaCustos()" placeholder="5" min="0" max="300" value="0">
                                            </div>
                                            <div class="form-inline">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-success" ng-disabled="carregando" data-toggle="modal" data-target="#observacoes">
