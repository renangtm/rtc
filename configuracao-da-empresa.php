                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Configuração da Empresa</h2>
                                <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">      
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">RTC</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Configuração da Empresa</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
								<div class="row">
									<div class="col-3 text-center">
										<p class=""> Clique na imagem ao lado para trocar o logo da sua empresa</p>
								...
								<div class="row">
									<div class="col">
									   ...
									   <div class="form-group row">
										  ...
										  <div class="col-9 col-lg-10">
											 <input id="txtname" type="text" required placeholder="Agro Fauna" class="form-control is-invalid">
									   ...
									   <div class="form-group row">
										  ...
										  <div class="col-9 col-lg-10">
											 <input id="txtend" type="text" required data-parsley-type="email" placeholder="Rua professor cavaleiro Salem" class="form-control">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
									   ...
									   <div class="form-group row">
										  ...
										  <div class="col-9 col-lg-10">
											 <input id="txtendnum" type="text" required placeholder="1136" class="form-control">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
									   ...
									   <div class="form-group row">
										  ...
										  <div class="col-9 col-lg-10">
											 <input id="txtbairro" type="text" required placeholder="Bonsucesso" class="form-control">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
									   ...
									   <div class="form-group row">
										  ...
										  <div class="col-9 col-lg-10">
											 <select name="cidades" class="form-control"> 
													...
													<option value="sp" selected>Guarulhos</option> 
									   ...
									   <div class="form-group row">
										  ...
										  <div class="col-9 col-lg-10">
											 <input id="txtcep" type="text" required placeholder="07195-201" class="form-control cep" maxlength="9">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
									...
									<div class="col">
									  <div class="form-group row">
									   ...
									   <div class="form-group row">
										  <label for="txtjurosmes" class="col-3 col-lg-2 col-form-label text-left">Juros mês</label>
										  <div class="col-9 col-lg-10">
											 <input id="txtjurosmes" type="text" required placeholder="1.015" class="form-control">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
									   ...
									   <div class="form-group row">
										  <label for="txtsemjuros" class="col-3 col-lg-2 col-form-label text-left">Sem juros</label>
										  <div class="col-9 col-lg-10">
											 <input id="txtsemjuros" type="text" required placeholder="30.0" class="form-control">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
									   ...
									   <div class="form-group row">
										  <label for="txtlucro" class="col-3 col-lg-2 col-form-label text-left">Lucro</label>
										  <div class="col-9 col-lg-10">
											 <input id="txtlucro" type="text" required placeholder="10.1" class="form-control">
											 <div class="invalid-feedback">
												Please provide a valid text.
											 </div>
										  </div>
