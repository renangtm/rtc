                                                                                ...
                                                                                <tbody style="">
                                                                                    <tr style="border-collapse: collapse;">
                                                                                        <td align="center" style="padding: 0px; margin: 0px;">
                                                                                            ...
                                                                                            <p style="margin: 0px; text-size-adjust: none; font-size: 14px; font-family: arial, &quot;helvetica neue&quot;, helvetica, sans-serif; line-height: 21px; color: rgb(255, 255, 255);">Telefone: <span class="Object" role="link" id="OBJ_PREFIX_DWT95_com_zimbra_phone"><a href="callto:<?php echo $p->empresa->telefone->numero; ?>" onclick="window.top.Com_Zimbra_Phone.unsetOnbeforeunload()"><?php echo $p->empresa->telefone->numero; ?></a></span><br><bR></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
