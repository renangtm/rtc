...
class testeProdutoPedidoSaida extends PHPUnit_Framework_TestCase {
    ...
    public function testSimple() {
        ...
        try{
            ...
            $this->assertEquals($e->getMessage(),"Sem estoque disponivel para executar essa operacao");
        ...
        $pedido->produtos[0]->quantidade = 20;
        $pedido->produtos[0]->merge(new ConnectionFactory());        
        $this->assertEquals($produto->disponivel,65);
        $this->assertEquals(count($pedido->produtos[0]->retiradas),4);
        $this->assertEquals($pedido->produtos[0]->retiradas[0][1],15);
        $this->assertEquals($pedido->produtos[0]->retiradas[1][1],2);
        $this->assertEquals($pedido->produtos[0]->retiradas[2][1],2);
        $this->assertEquals($pedido->produtos[0]->retiradas[3][1],1);  
        ...
        $lote = $produto3->getLotes(new ConnectionFactory());
        $this->assertEquals($lote[0]->quantidade_real,24);
        ...
        try{
            ...
            $this->assertEquals($e->getMessage(),"Nao e possivel separar essa quantidade");
