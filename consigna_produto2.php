                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-8 col-12">
                                                <div style="width:100%;background-position:center top;background-size:100% auto;background-repeat: no-repeat;background-image:url('assets/images/tira-adagro.jpg')">
                                                    <div class="container">
                                                        <div class="row" style="padding: 0px;">
                                                            <div style="margin-top: 150px;padding:40px;background-color: #13161f;color:#fff;">
                                                                ...
                                                                <p style="text-align: justify;">Para que nossa parceria possa ser implantada será necessário estabelecer um contrato com a empresa Virtual Negócios e Servicos que representara a <?php echo $empresa->nome; ?> fazendo a intervenção de vendas on-line em todo o Brasil.</p>
                                                    ...
                                                    <div id="carouselExampleIndicators" class="passoapasso carousel slide" data-interval="false" data-ride="carousel" data-pause="hover" style="border: 1px solid rgba(0,0,0,.1);margin-bottom: 40px;">
                                                        ...
                                                        <div class="carousel-inner">
                                                            <div class="carousel-item active">
                                                                <img class="d-block w-100" src="assets/images/passo_a_passo/Slide1.PNG" alt="First slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="assets/images/passo_a_passo/Slide2.PNG" alt="Second slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="assets/images/passo_a_passo/Slide3.PNG" alt="Third slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="assets/images/passo_a_passo/Slide4.PNG" alt="Third slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="assets/images/passo_a_passo/Slide5.PNG" alt="Third slide">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row" ng-if="liberadoc">
                                            <div class="col-md-12">
                                                ...
                                                <div id="contrato" style="width:100%;height:600px;border:2px solid;overflow-y:scroll;padding:10px;margin:10px">
                                                    ...
                                                    CONTRATANTE: <strong>{{empresa_av.nome}}</strong>,com sede em  <strong>{{empresa_av.endereco.cidade.nome}}</strong>, na Rua <strong>{{empresa_av.endereco.rua}}</strong>, nº <strong>{{empresa_av.endereco.numero}}</strong>, bairro  <strong>{{empresa_av.endereco.bairro}}</strong>, Cep  <strong>{{empresa_av.endereco.cep.valor}}</strong>, no Estado  <strong>{{empresa_av.endereco.estado}}</strong>, inscrita no C.N.P.J. sob o nº  <strong>{{empresa_av.cnpj.valor}}</strong>, e no Cadastro Estadual sob o nº  ........, neste ato representada por  Sr(a). <?php echo $usuario->nome; ?>, (Nacionalidade), (Estado Civil), (Profissão), Carteira de Identidade nº  ......  
                                                    <br><br>
                                                    ...
                                                    <br><br>
                                                    Cláusula 1ª.1 - A CONTRATADA se obriga a disponibilizar uma plataforma de vendas – Loja Virtual, desenvolvida para possibilitar a comercialização de produtos diretamente pela internet.
                                                    <br><br>
                                                    <h3>DAS OBRIGAÇÕES DA CONTRATADA</h3>
                                                    Cláusula 2ª - A CONTRATADA está obrigada a promover a veiculação, em sua página na internet www.rtcagro.com.br (designar o endereço eletrônico da página), das imagens das mercadorias produzidas pela CONTRATANTE.
                                                    <br><br>
                                                    ...
                                                    Cláusula 7ª - A CONTRATANTE deverá pagar à CONTRATADA o percentual de 2% (dois por cento) a título de comissão dos valores comercializados através da plataforma virtual de vendas, cujo valor deverá ser pago da seguinte forma:______________________
                                                    <br><br>
                                                    Cláusula 8ª - O repasse do valor obtido na venda desses produtos deve se dar em até  ........ dias a partir do __________(venda ou recebimento).
                                                    <br><br>
                                                    ...
                                                    <br><br>
                                                    Cláusula 11ª - O contrato também será rescindido caso uma das partes descumpra o estabelecido nas cláusulas do presente instrumento, cabendo à que ocasionou o rompimento do mesmo, o pagamento de multa rescisória, fixada em R$  ........ (.... reais), à outra parte.   
                                                    <br><br>
                                                    ...
                                                    <br><br>
                                                    Cláusula 13ª - A CONTRATANTE arcará com o ônus financeiro dos tributos, contribuições sociais, encargos, dentre outras modalidades de impostos que porventura venham a incidir sobre o uso e destinação da loja virtual ora contratada, além de responder por direitos de terceiros eventualmente prejudicados.    
                                                    <br><br>
                                                    ...
                                                    <br><br>
                                                    Cláusula 19ª - As partes se obrigam a manter os seus dados comerciais devidamente atualizados; toda e qualquer alteração deverá ser comunicada imediatamente, uma à outra.          
                                                    <br><br>
                                                    ...
                                                    Cláusula 23ª - Para dirimir quaisquer controvérsias oriundas do presente contrato, as partes elegem o foro da comarca de ............                  
                                                    <br><br>
                                                    Por estarem assim justos e contratados, firmam o presente instrumento, em duas vias de igual teor, juntamente com 2 (duas) testemunhas.
                                                    <br><br>
                                                    <p>Guarulhos-SP, _____, __________________, 2019</p>
                                                    <br>
                                                    <p><center>__________________________ &emsp;&emsp;&emsp;&emsp; _________________________</center></p>
                                                    <p><center>CONTRATADA &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; CONTRATANTE</center>
                                                    <br><br>
                                        ...
                                        <div class="table-responsive" style="overflow: hidden" ng-if="liberadoc">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <hr>
                                                    <br>
                                                    <i class="fas fa-plus-circle" style="display:inline"></i>&nbsp<h4 style="display: inline">Aditivo contratual de representação comercial para venda de produtos entre as partes (<strong>{{empresa_selecionada.nome}}</strong> e <?php echo $empresa->nome; ?>)</h4> 
                                                    <br>
                                                    <br>
                                                    <table class="table table-striped table-bordered first">
                                                        <thead>
