            ...
            <div class="dashboard-wrapper">
                <div class="dashboard-ecommerce">
                    <div class="container-fluid dashboard-content ">
                        ...
                        <!-- ============================================================== -->
                        <div class="">
                            <div ng-repeat="pedido in pedidos" ng-if="!finalizado(pedido)" style="display: inline-block; width:48%; min-width:500px;margin-left:10px">
                                    ...
                                    <table class="table table-striped" style="margin-bottom: 10px;">
                                        <thead>
                                            <tr style="border-top: 0px solid red;">
                                                ...
                                                <th class="right">Vl. Base</th>
                                                <th class="right">BC</th>
                                                <th class="right">ICMS</th>
                                                <th class="right">C. Fin</th>
                                                <th class="right">Frete</th>
                                                <th class="right">Sub Tot.</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    ...
                                    <div class="col-lg-10 col-sm-10 ml-auto">
                                        <table class="table table-clear">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="left">
                                                        <strong class="text-dark"><i class="fas fa-truck"></i>&nbspTipo de Frete: </strong>&nbsp&nbsp
                                                        <div class="custom-control custom-radio custom-control-inline" style="margin-top: 5px;">
                                                            ...
                                                            <label class="custom-control-label" for="ra{{pedido.identificador}}">Por conta da Empresa</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline" style="margin-top: 5px;">
                                                            ...
                                                            <label class="custom-control-label" for="rb{{pedido.identificador}}">Por sua conta</label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="left">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-1">
                                                                    <button ng-if="!pedido.frete_incluso" ng-click="setPedidoContexto(pedido)" class="btn btn-outline-light btnedit" data-toggle="modal" data-target="#transportadoras" ng-disabled="!pedido.status.altera"><i class="fas fa-search"></i><span class="indicator" ng-if="pedido.transportadora === null"></span></button>
                                                                </div>
