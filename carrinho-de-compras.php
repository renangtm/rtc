                                        ...
                                        <table class="table table-striped" style="margin-bottom: 10px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="center" width="10%"><img src="http://www.faunasystem.com.br:8080/rtc/ENVIDOR-FRC-400ML.png" class="product-image"></td>
                                                    <td class="left">Envidor (Frc 400ml)</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center" width="10%"><img src="http://www.faunasystem.com.br:8080/rtc/ridomilgold1kg.png" class="product-image"></td>
                                                    <td class="left">Ridomil Gold MZ (Pct 1kg)</td>
													<td class="text-center">5</td>
                                                    <td class="right">R$ 116.99</td>
                                                    <td class="text-center"><input id="inputText4" type="number" class="form-control" placeholder="5" min="1" max="5"></td>
                                                    <td class="right">R$ 584.95</td>
                                            ...
                                            <table class="table table-clear">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="left">
															...
															<select class="form-control" id="fretes" style="margin-top:20px;height: 50px" onchange="r_elementos.tblProdutos.recarregar()">    
																<option value="7">FRETE POR SUA CONTA</option>
																<option value="0">Retirar na Matriz, São José do Rio Preto, R$ 53.76</option>
																<option value="1">rodonasa cargas e encomendas ltda me, R$ 130.60</option>
																<option value="2">transville transportes e servicos ltda, R$ 111.10</option>
																<option value="3">alfa transportes eireli, R$ 97.12</option>
																<option value="4">hb transportes e logistica ltda, R$ 156.00</option>
																<option value="5">transortadora capivari ltda, R$ 241.64</option>
																<option value="6">modular transportes ltda, R$ 144.88</option>
															</select>
                                                        </td>
                                                        <td class="right" style="vertical-align: bottom;">R$ 4831.75</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="left">
                                                            <strong class="text-dark">Pagamento</strong>
															<select class="form-control" id="formaPagamento" style="margin-top:20px;height: 50px">    
																<option value="0" data-parcelas="1">Antecipado</option>
																<option value="30" data-parcelas="1">30 Dias</option>
																<option value="60" data-parcelas="1">60 Dias</option>
																<option value="90" data-parcelas="1">90 Dias</option>
																<option value="60" data-parcelas="2">30/60</option>
																<option value="90" data-parcelas="2">45/90</option>
																<option value="90" data-parcelas="3">30/60/90</option>
															</select>
                                                        </td>
                                                        <td class="right" style="vertical-align: bottom;">R$ 4831.75</td>
                                                    </tr>
                                                    <tr style="font-size: 1.2rem;">
                                                        ...
                                                        <td class="right">
                                                            <strong class="text-dark">R$ 4831.75</strong>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
									...
									<div class="col mb-2 m-t-40">
										<div class="row">
											...
											<div class="col-sm-12 col-md-6 text-right">
												<button class="btn btn-lg btn-block btn-primary text-uppercase">Finalizar Compra</button>
											</div>
										</div>
									</div>
								</div>
