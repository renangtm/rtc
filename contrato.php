                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
							...
							<!-- contrato -->
								<iframe id="iframe" name="myIframe" frameborder="1" width="80%" height="400" src="contrato_v1.html"></iframe>
								</div>
								<div class="col text-center">
									<button class="btn col-4 m-t-10" ><i class="fa fa-check"></i>&nbsp;&nbsp;Contrato aceito</button>
								</div>	
