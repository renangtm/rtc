                ...
                <tr>
                    <td style="padding:10px;">
                        <table>
                            ...
                            <tr>
                                <td>Email Transportadora:</td>
                                <td id="emailTransportadora"></td>
                            </tr>
                            <tr>
                                <td>CNPJ Transportadora:</td>
                                <td id="cnpjTransportadora"></td>
                            </tr>
                            <tr>
                                <td>Cidade/Estado Transportadora:</td>
                                <td id="cidadeEstadoTransportadora"></td>
                            </tr>
                            <tr>
                                <td>Telefone Transportadora:</td>
                                <td id="telefoneTransportadora">
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td width="100%" style="padding:10px; border: 1px solid black;">
                        <table>
                            ...
                            <tr>
                                <td>Transportadora:</td>
                                <td id="nomeTransportadora"></td>
                            </tr>
                            <tr>
                                <td>Contato:</td>
                                <td id="contatoTransportadora"></td>
                            </tr>
                            <tr>
                                <td>Valor:</td>
                                <td id="valorFrete">0.0</td>
                            </tr>
                        </table>
